package io.github.palexdev.enbmanager.components.misc;

import io.github.palexdev.enbmanager.SpringHelper;
import io.github.palexdev.enbmanager.components.ConfigsList;
import io.github.palexdev.enbmanager.components.dialogs.ConfigDetailsDialog;
...
public class ConfigCell extends HBox implements Cell<Config> {
    ...
    protected void showDetails() {
        ...
        DialogServiceBase.DialogService dialogService = SpringHelper.getBean(DialogServiceBase.DialogService.class);
        ConfigDetailsDialog dialog = ConfigDetailsDialog.instance();
        dialog.setConfig(config);
        dialogService.showDialog(MainView.class, dialog, () ->
            new DialogServiceBase.DialogConfig<>()
                .implicitOwner()
